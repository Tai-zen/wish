...
import re 
import os
from datetime import datetime, timedelta # Import timedelta for persistence
...
@socketio.on('connect')
def handle_connect(auth): # auth parameter receives the client's auth data
...
if __name__ == '__main__':
    ...
    socketio.run(app, host='0.0.0.0', port=5050, debug=True)# app.py
from flask import Flask, render_template, request
from flask_socketio import SocketIO, emit
import threading
import time
